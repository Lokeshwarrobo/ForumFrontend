...
export const QuestionDetail = () => {
	...
	const [ans, setAns] = useState(answerlu)
	const[bes, setBes] = useState(bestAns)
	...
	const saveBest = (e) => {
		var data = {
			answerId: 22,
			bestAnswer:bes.bestAnswer
		}

		ForumService.bestAnswer(data.answerId, data)
		.then(res => {
	...
	const saveAns = () => {
		...
		ForumService.postAnAnswer(data)
		.then(res =>{
			if (res.data == "") {
				toast.error("iiodf")
			}
	...
	const recent = (e) => {
        ForumService.sortByRecent(questionid)
        .then(
            res => {
				console.log(res.data)
                setAns(res.data)
                 ...
                 <div class="tt-single-topic">
                    <div class="tt-item-header">
                        <div class="tt-item-info info-top">
                            <div class="tt-avatar-icon">
                                <i class="tt-icon"><svg><use xlinkHref="#icon-ava-d"></use></svg></i>
                            </div>
                            <div class="tt-avatar-title">
                               <a href="#">{sessionStorage.getItem('userName')}</a>
                            </div>
                            <a href="#" class="tt-info-time">
                                <i class="tt-icon"><svg><use xlinkHref="#icon-time"></use></svg></i>{questions.questionDate}
                            </a>
                        </div>
                    ...
                    <div class="tt-item-info info-bottom">
                        <a href="#" class="tt-icon-btn">
                            <i class="tt-icon"><svg><use xlinkHref="#icon-like"></use></svg></i>
                ...
                <div class="tt-info-box">
                    <div class="row-object-inline form-default">
                        ...
                        <ul class="tt-list-badge tt-size-lg">
                            {/* <li onClick={(e) => recent(e)}><a ><span class="tt-badge">Recent</span></a></li>
                ...
                answers.map(
                    ...
                    <div class="tt-single-topic">
                       <div class="tt-item-header pt-noborder">
                           <div class="tt-item-info info-top">
                               <div class="tt-avatar-icon">
                                   <i class="tt-icon"><svg><use xlinkHref="#icon-ava-t"></use></svg></i>
                               </div>
                               <div class="tt-avatar-title">
                                  <a href="#">{answers.userName}</a>
								  {
					answers.bestAnswer === true && 
					<span class="tt-color13 tt-badge">best answer</span>
				}
                               </div>
                               <a href="#" class="tt-info-time">
                                   <i class="tt-icon"><svg><use xlinkHref="#icon-time"></use></svg></i>{answers.answeredDate}
                               </a>
                           </div>
                       </div>
                       <div class="tt-item-description">
					   ...
					   <br/>
					   {
					answers.bestAnswer === false && <div class="form-check">
					<input class="form-check-input" type="checkbox" value="1" onChange = {handleInputChanges} id="flexCheckChecked"  />
					<button onClick={ (e) => saveBest(e)}  class="form-check-label" for="flexCheckChecked">
					  best 
					</button>
				  </div>
        ...
        <div class="tt-wrapper-inner">
            <div class="pt-editor form-default">
                ...
                <div class="form-group">
                    <textarea name = "answer" id = "answer" value ={ans.answer} onChange = {handleInputChange} class="form-control" rows="5" placeholder="Lets get started"></textarea>
                </div>
                <div class="pt-row">
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <a onClick= {(e) => saveAns(e)} href="" class="btn btn-secondary btn-width-lg">Reply</a>
                    </div>
                </div>
            </div>
        </div>
