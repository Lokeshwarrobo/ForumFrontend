...
const Test = () => {
    ...
    const search = sessionStorage.getItem('searchs')
    const {se} = useParams()
    const init = () => {
        ...
        ForumService.searchQuestion(search)
            .then(res => {
        ...
        <>
            <main id="tt-pageContent" class="tt-offset-small">
                ...
                <div class="container">
                    ...
                    <div class="tt-topic-list">
                        <div class="tt-list-header">
                            <div class="tt-col-topic">Question</div>
               ...
               !le ? (
                ...
                <h6 class="tt-title">No Search Results </h6>
                                ...
                                questions =>
                                    ...
                                    //         categories =>
                                                <div class={questions.questionId % 2 == 0 ? "tt-item tt-itemselect" : "tt-item"} >
                                                    ...
                                                    {/* {console.log(  categories[questions.categoryId].categoryId)}  */}
