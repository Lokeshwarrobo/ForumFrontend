...
const Home = () => {
  ...
  const init = () => {
    ...
    ForumService.getUserId(userName)
      .then(res => {
        setUserId(res.data)
      })
      .catch(error => {
    ...
    ForumService.diplayAllQuestions()
      .then(res => {
...
//   const changeColor = like ? "red" : "grey"
    ...
    <>
     {
               !le ? (
                ...
                <h6 class="tt-title">No Questions are there </h6>
                <p>To ask a new Question<br/>
                 <a href="/create" class="tt-color-dark tt-underline-02">Click here</a> 
                 </p>
             </div>
               ) :
               (
    ...
    <div class="container">
        ...
        <div class="tt-topic-list">
            <div class="tt-list-header">
                <div class="tt-col-topic" style={{marginLeft:"10%"}}>Question</div>
                <div class="tt-col-category">Category</div>
                <div class="tt-col-value hide-mobile">Likes</div>
                <div class="tt-col-value hide-mobile">Replies</div>
                <div class="tt-col-value hide-mobile">Views</div>
                <div class="tt-col-value">PostedOn</div>
            </div>
            {
              questions.map(
                questions =>
           ...
           <div class={questions.questionId % 2 == 0 ? "tt-item tt-itemselect" : "tt-item"} >
                ...
                <div class="tt-col-description">
                    <h6 class="tt-title"><a href="page-single-topic.html" onClick = {() => setViews(views + 1)}>
                        
                    <Link to={`/view/${questions.questionId}/${views}`}>{questions.question}</Link> 
                    </a></h6>
                    <div class="row align-items-center no-gutters">
                        <div class="col-11">
                            <ul class="tt-list-badge">
                                <li class="show-mobile"><a href="#"><span class="tt-color01 tt-badge">
                                    {categories.categoryName}</span></a></li>
                                
                                <li><a href="#"><span class="tt-badge">{questions.userName}</span></a></li>
                            </ul>
                        </div>
                ...
                <div class="tt-col-category" style={{marginLeft:"10%"}}><span class={questions.questionId % 2 == 0 ? "tt-color07 tt-badge" :"tt-color01 tt-badge" } >
                                                       {categories?.find((cat)=> cat.categoryId === questions.categoryId).categoryName}</span></div>    
                <div class="tt-col-value hide-mobile">985</div>
                <div class="tt-col-value tt-color-select hide-mobile">{questions.replies}</div>
                <div class="tt-col-value hide-mobile">{questions.views}</div>
                <div class="tt-col-value hide-mobile">{questions.questionDate}</div>
            </div>  
                    <br/>
            </div>  
                )
...
<g>
	<path class="st0" fill="#E6E6E6" d="M290.06,54H40.94C37.66,54,35,51.34,35,48.06V5.94C35,2.66,37.66,0,40.94,0h249.13c3.28,0,5.94,2.66,5.94,5.94
		v42.13C296,51.34,293.34,54,290.06,54z"/>
</g>
<g>
	<path class="st1" fill="#CCCCCC" d="M62,38.5c-6.34,0-11.5-5.16-11.5-11.5S55.66,15.5,62,15.5S73.5,20.66,73.5,27S68.34,38.5,62,38.5z"/>
</g>
<g>
	<path class="st2" fill="#B3B3B3" d="M270,20.5H89c-1.38,0-2.5-1.12-2.5-2.5s1.12-2.5,2.5-2.5h181c1.38,0,2.5,1.12,2.5,2.5S271.38,20.5,270,20.5z"
		/>
</g>
<g>
	<path class="st2" fill="#B3B3B3" d="M143,38.5H89c-1.38,0-2.5-1.12-2.5-2.5s1.12-2.5,2.5-2.5h54c1.38,0,2.5,1.12,2.5,2.5S144.38,38.5,143,38.5z"/>
</g>
<g>
	<path class="st3" fill="#3471B8" d="M255.06,118H5.94C2.66,118,0,115.34,0,112.06V69.94C0,66.66,2.66,64,5.94,64h249.13
		c3.28,0,5.94,2.66,5.94,5.94v42.13C261,115.34,258.34,118,255.06,118z"/>
</g>
<g>
	<path class="st4" fill="#F2F2F2" d="M27,102.5c-6.34,0-11.5-5.16-11.5-11.5S20.66,79.5,27,79.5S38.5,84.66,38.5,91S33.34,102.5,27,102.5z"/>
</g>
<g>
	<g>
		<path class="st4" fill="#F2F2F2" d="M60,84.5h-6c-1.38,0-2.5-1.12-2.5-2.5s1.12-2.5,2.5-2.5h6c1.38,0,2.5,1.12,2.5,2.5S61.38,84.5,60,84.5z"/>
	</g>
	<g>
		<path class="st4" fill="#F2F2F2" d="M189.73,84.5h-12.16c-1.38,0-2.5-1.12-2.5-2.5s1.12-2.5,2.5-2.5h12.16c1.38,0,2.5,1.12,2.5,2.5
	...
	<g>
		<path class="st4" fill="#F2F2F2" d="M216,84.5h-6c-1.38,0-2.5-1.12-2.5-2.5s1.12-2.5,2.5-2.5h6c1.38,0,2.5,1.12,2.5,2.5S217.38,84.5,216,84.5z"/>
	</g>
</g>
<g class="st5" opacity="0.35">
	<path class="st4" fill="#F2F2F2" d="M134,102.5h-16c-1.38,0-2.5-1.12-2.5-2.5s1.12-2.5,2.5-2.5h16c1.38,0,2.5,1.12,2.5,2.5S135.38,102.5,134,102.5
...
<g>
	<path class="st0" fill="#E6E6E6" d="M290.06,181H40.94c-3.28,0-5.94-2.66-5.94-5.94v-42.13c0-3.28,2.66-5.94,5.94-5.94h249.13
		c3.28,0,5.94,2.66,5.94,5.94v42.13C296,178.34,293.34,181,290.06,181z"/>
</g>
<g>
	<path class="st1" fill="#CCCCCC" d="M62,165.5c-6.34,0-11.5-5.16-11.5-11.5s5.16-11.5,11.5-11.5s11.5,5.16,11.5,11.5S68.34,165.5,62,165.5z"/>
</g>
<g>
	<path class="st2" fill="#B3B3B3" d="M224,147.5H89c-1.38,0-2.5-1.12-2.5-2.5s1.12-2.5,2.5-2.5h135c1.38,0,2.5,1.12,2.5,2.5S225.38,147.5,224,147.5
		z"/>
</g>
<g>
	<path class="st2" fill="#B3B3B3" d="M152,165.5H89c-1.38,0-2.5-1.12-2.5-2.5s1.12-2.5,2.5-2.5h63c1.38,0,2.5,1.12,2.5,2.5S153.38,165.5,152,165.5z
		"/>
</g>
<g class="st6" opacity="0.42">
	<path class="st7" fill="#808080" d="M276.02,166.51c-15.37,0-30.74-5.85-42.44-17.55c-23.4-23.4-23.4-61.48,0-84.88c23.4-23.4,61.48-23.4,84.88,0
...
<g>
	<circle class="st4" fill="#F2F2F2" cx="276.02" cy="106.52" r="36"/>
	<path class="st8" fill="#677075" d="M276.02,145.52c-10.42,0-20.21-4.06-27.58-11.42s-11.42-17.16-11.42-27.58c0-10.42,4.06-20.21,11.42-27.58
...
<g>
	<path class="st8" fill="#677075" d="M301.48,143.97c-3.07,0-6.15-1.17-8.49-3.51c-1.17-1.17-1.17-3.07,0-4.24c1.17-1.17,3.07-1.17,4.24,0
...
<g>
	<path class="st8" fill="#677075" d="M341.07,183.57c-3.07,0-6.15-1.17-8.48-3.51l-18.38-18.38c-4.68-4.68-4.68-12.29,0-16.97
...
<g>
	<path class="st8" fill="#677075" d="M316.32,149.82c-0.77,0-1.54-0.29-2.12-0.88l-8.49-8.49c-1.17-1.17-1.17-3.07,0-4.24
		c1.17-1.17,3.07-1.17,4.24,0l8.49,8.49c1.17,1.17,1.17,3.07,0,4.24C317.86,149.53,317.09,149.82,316.32,149.82z"/>
</g>
<g>
	<path class="st8" fill="#677075" d="M339.66,173.16c-0.77,0-1.54-0.29-2.12-0.88c-1.17-1.17-1.17-3.07,0-4.24l6.36-6.36
