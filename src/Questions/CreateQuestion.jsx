...
const CreateQuestion = () => {
    ...
    const saveQuestion = (e) => {
        ...
        ForumService.createAQuestion(data)
        .then(res => {
            if(data.question == "" || data.questionDesc == "" || data.categoryId == "") {
    ...
    useEffect(() => {
      ...
      const Tittlevalidation = () => {
        if(question.question == "") {
            setTittleerror("Enter the question");
        }
        else {
            setTittleerror("");
        }
            ...
            <form class="form-default form-create-topic">
                <div class="form-group">
                    ...
                    <div class="tt-value-wrapper">
                        ...
                        onBlur= {Tittlevalidation}
                        placeholder="Subject"  />
                        <span class="tt-value-input">255</span>
                    </div>
                    <div class="tt-note">Describe your question well, while keeping the subject as short as possible.</div>
                    <div style={{color:"red", fontFamily:"calibri"}}>
                        {tittleerror}
                    </div>
                </div>
                <div class="pt-editor">
                    ...
                    <div class="form-group">
                        <textarea name="questionDesc" id ="questionDesc" value = {question.questionDesc}
                        onChange = {handleInputChange} class="form-control" rows="5" 
                        onBlur= {Descriptionvalidation}
                        placeholder="Lets get started" required></textarea>
                    </div>
                    <div style={{color:"red", fontFamily:"calibri"}}>
                        {descerror}
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select value = {question.categoryId} name="categoryId" id = "categoryId"  onChange = {handleInputChange} onBlur= {CategoryValidation}>
                     ...
                     <div class="row">
                        <div class="col-auto ml-md-auto">
                            <a onClick={(e) => saveQuestion(e)} style = {{color:"white"}} class="btn btn-secondary btn-width-lg">Create Post</a>
                        </div>
                    </div>
                </div>
            </form>
